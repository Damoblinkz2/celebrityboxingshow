import livestream from "../assets/images/livestreamTicket.svg";
...
const Livestream = () => {
  ...
  useEffect(() => {
    ...
    ticketNumber.innerText = `${count}x - Livestream Ticket`;
          ...
          <div className="ticket-field">
            <div className="upper">
              <div className="ticket-img">
                <img src={livestream} alt="inperson img" />
              </div>
              <div className="ticket-count">
                ...
                <div className="ticket-count-lower">
                  <div className="ticket-count-1">
                    <p className="p-ticket-type">Livestream Ticket</p>
